...
As a user I want to be able to get information about a todo task that was added to the todo list
  ...
  Background:
    ...
    Scenario: Get a todo instance with a valid project_id value
        ...
        And the returned todo instance should have the corresponding project_id, title, doneStatus and description values
    ...
    Scenario: Get a todo instance with a valid project_id value but specifically in XML format
        ...
        And the returned todo instance should have the corresponding project_id, title, doneStatus and description values as XML
        And the API should have a return status code of 200
    ...
    Scenario: Get a todo instance with a non existing project_id value
        When I send a GET request to the Rest API with a "<project_id>" value of "5000" and there is no todo instance with that project_id value
